...
#       respond_with @user, status: :ok
        render json: retorno(@user), status: :ok
    end
    ...
    def retorno(user)
        {
            id: user.id, user_type: user.user_type, status: user.status, username: user.username, name: user.name, first_last_name: user.first_last_name, second_last_name: user.second_last_name, email: user.email
        }
    end    
end
